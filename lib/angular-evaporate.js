    ...
    .directive('evaporate', ['eva', function (eva) {
      ...
      function link (scope, element) {
        ...
        var data = scope.data,
          ...
          onStart = (typeof data.onStart === 'function' ? data.onStart : foo);
        ...
        if (eva._.supported) {
          ...
          element.bind('change', function (event) {
            // support for 1 file upload only
            onStart(event.target.files[0]).then(function (hashName) {
